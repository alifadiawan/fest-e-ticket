...
<body class="min-h-screen bg-gray-50 flex items-center justify-center relative overflow-hidden">
    ...
    <div id="registrationCard"
        ...
        @if(isset($error))
            <div
                class="flex cursor-not-allowed justify-center items-center gap-2 w-full bg-zinc-100 rounded-lg px-6 py-3 text-sm font-medium text-zinc-500 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
